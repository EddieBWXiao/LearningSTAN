  ...
  model {
    ...
    real PEchosen;     // prediction error
    real PEunchosen;     // prediction error
    ...
    for (t in 1:T) {
      ...
      // Prediction error
      PEchosen   =  outcome[t,choice[t]] - ev[choice[t]];
      PEunchosen   =  outcome[t,3-choice[t]] - ev[3-choice[t]];

      // Value updating (learning)
      ev[choice[t]]   += alpha * PEchosen;
      ev[3-choice[t]]   += alpha * PEunchosen;
    }
  }
